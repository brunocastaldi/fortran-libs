!! ***
!! Performs a set of basic statistical analysis on a defined derived type variable that stores a 1-D Array with scalar values, an
!!  auxiliary "label" variable, and all the requested statistical parameters.
!!
